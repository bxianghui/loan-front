<template>
  <ul>
    ...
    <li :class="{ 'pleft-cur': $route.fullPath === '/user/invest' }">
      <span>
        <NuxtLink style="text-align: center; width: 115px" to="/user/borrow">
          借款记录
        </NuxtLink>
      </span>
    </li>
    <li :class="{ 'pleft-cur': $route.fullPath === '/user/return' }">
      <span>
        <NuxtLink style="text-align: center; width: 115px" to="/user/return">
          还款计划
        </NuxtLink>
      </span>
    </li>
