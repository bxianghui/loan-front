<template>
  <div class="app-container">
    ...
    <el-table :data="list" border stripe>
      ...
      <el-table-column prop="integral" label="用户积分" width="200" />
      ...
      <el-table-column label="操作" align="center" width="300">
        <template slot-scope="scope">
          ...
          <el-button type="primary" size="mini" @click="reset(scope.row.id)">
            重置密码
          </el-button>
          <el-button
            type="primary"
  ...
  methods: {
    ...
    showLoginRecord(id) {
      ...
      userInfoApi.getuserLoginRecordTop50(id).then((response) => {
        this.loginRecordList = response.data;
      });
    },

    reset(id) {
      userInfoApi.reSetPassword(id).then((response) => {
        this.$message.success(response.message);
        this.fetchData();
      });
    },
